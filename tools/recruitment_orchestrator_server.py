...
_agent = make_recruitment_agent(db=_db)
...
async def handle_recruitment_message(message: str, session_id: str) -> str:
    ...
    A resposta pode conter texto em markdown e blocos JSON com prefixo __widget
    ...
    Returns:
        Resposta do agente em markdown, podendo incluir blocos JSON de widget.
    """
